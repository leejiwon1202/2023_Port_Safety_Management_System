...
origin_path1 = "/home/jiwon/Harbor_Data/TL/YT/"
origin_path2 = "/home/jiwon/Harbor_Data/TL/TwistLock/"

target_path = "/home/jiwon/Harbor_Data/train/labels/"

yt_list = os.listdir(origin_path1)  # 73037
tl_list = os.listdir(origin_path2)  # 4458
print(len(yt_list), len(tl_list), len(yt_list) + len(tl_list))  # 77495
...
# print(len(os.listdir(target_path))) # 77495
# print(len(os.listdir("/home/jiwon/Harbor_Data/train/images"))) # 77495